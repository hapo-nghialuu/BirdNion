...
const STRINGS: Record<string, { vi: string; en: string }> = {
  ...
  "profileSwitchTitle.claude": { vi: "Backend Claude Code", en: "Claude Code backend" },
  "profileSwitchTitle.codex": { vi: "Cấu hình Codex", en: "Codex configuration" },
  profileSwitchCustom: { vi: "Tùy chỉnh", en: "Custom" },
  profileSwitchNeedsSetup: { vi: "Cần cấu hình", en: "Needs setup" },
  "profileSwitchState.needsSetup": { vi: "Cần setup", en: "Needs setup" },
  "profileSwitchState.ready": { vi: "Sẵn sàng", en: "Ready" },
  "profileSwitchState.active": { vi: "Đang dùng", en: "Active" },
  "profileSwitchState.stale": { vi: "Cần cập nhật", en: "Needs update" },
  ...
  settingsCodexAutoPrimeTitle: {
    vi: "Tự động kích hoạt window 5h",
    en: "Auto-Prime 5h Window",
  },
  settingsCodexAutoPrimeToggle: { vi: "Tự kích hoạt", en: "Auto-prime" },
  settingsCodexAutoPrimeToggleSubtitle: {
    vi: "Gửi 1 request nhỏ mỗi ngày để bắt đầu đồng hồ 5h đúng giờ làm việc.",
    en: "Sends one small request daily to start the 5h clock at your working hours.",
  },
  settingsCodexAutoPrimeTime: { vi: "Giờ kích hoạt", en: "Prime time" },
  settingsCodexAutoPrimeTimeSubtitle: {
    vi: "Chỉ kích hoạt khi window 5h đang nghỉ (chưa dùng).",
    en: "Only primes while the 5h window is idle (not yet used).",
  },
  notificationCodexPrimedTitle: {
    vi: "Codex đã được kích hoạt",
    en: "Codex window primed",
  },
  notificationCodexPrimedBody: {
    vi: "Window 5h bắt đầu lúc {time}.",
    en: "The 5h window started at {time}.",
  },
  ...
  copilotAccountsLabel: { vi: "Tài khoản Copilot", en: "Copilot accounts" },
  copilotAddAccount: { vi: "+ Thêm tài khoản", en: "+ Add account" },
  copilotNoAccounts: { vi: "Chưa có tài khoản GitHub nào.", en: "No GitHub accounts yet." },
  copilotOpenLogin: { vi: "Mở trang đăng nhập", en: "Open sign-in page" },
  copilotLoginCode: { vi: "Mã", en: "Code" },
  copilotLoginRequesting: { vi: "Đang lấy mã đăng nhập…", en: "Requesting device code…" },
  copilotLoginSuccess: { vi: "Đã thêm và chuyển sang {account}", en: "Added and switched to {account}" },
  copilotLoginDenied: { vi: "Yêu cầu đăng nhập bị từ chối.", en: "Login request was denied." },
  copilotLoginExpired: { vi: "Hết thời gian chờ xác thực.", en: "The login request expired." },
  ...
  "quotaAgenda.withData": { vi: "{n} provider có dữ liệu", en: "{n} providers with data" },
  "quotaAgenda.more": { vi: "+{n} provider khác ›", en: "+{n} more providers ›" },
  "quotaAgenda.close": { vi: "Đóng lịch quota", en: "Close Quota Agenda" },
  "quotaAgenda.emptyTitle": { vi: "Chưa có lịch reset rõ ràng", en: "No explicit reset schedule yet" },
  "quotaAgenda.emptyBody": { vi: "Làm mới provider để kiểm tra lại.", en: "Refresh providers to check again." },
  "quotaAgenda.explicitOnly": { vi: "CHỈ DÙNG MỐC RESET ĐƯỢC XÁC NHẬN", en: "EXPLICIT RESET TIMES ONLY" },
  "quotaAgenda.percentageUnavailable": { vi: "Chưa có phần trăm hiện tại", en: "Current percentage unavailable" },
